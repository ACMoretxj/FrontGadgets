<!-- reference: https://codepen.io/jcoulterdesign/pen/pjQdGb -->
<template>
  <div class="body">
    <div class='grain'></div>
    <div class='intro'>
      <div class='center'>
        ...
        <div class='pieces'>
          <div class='future_ui__piece' @click="onWarpDrive">
            <span>曲率航行</span>
            <div class='line'></div>
            <div class='tip'>
              Yes, commander!
          ...
          <div class='future_ui__piece' @click="onTeleport">
            <span>空间传送</span>
            <div class='line'></div>
            <div class='tip'>
              Beam me up!
          ...
          <div class='future_ui__piece' @click="onFusionCore">
            <span>聚变核心</span>
            <div class='line'></div>
            <div class='tip'>
              Engineering!
          ...
          <div class='future_ui__piece' @click="onLaserTarget">
            <span>激光目标</span>
            <div class='line'></div>
            <div class='tip'>
              Charge laz0rs!
          ...
          <div class='future_ui__piece' @click="onShield">
            <span>力场护盾</span>
            <div class='line'></div>
            <div class='tip'>
              Status report!
...
export default {
  ...
  methods: {
    onWarpDrive () {
      this.$emit('command', 'warp-drive')
    },

    onTeleport () {
      this.$emit('command', 'teleport')
    },

    onFusionCore () {
      this.$emit('command', 'fusion-core')
    },

    onLaserTarget () {
      this.$emit('command', 'laser-target')
    },

    onShield () {
      this.$emit('command', 'shield')
    }
  }
}
</script>
